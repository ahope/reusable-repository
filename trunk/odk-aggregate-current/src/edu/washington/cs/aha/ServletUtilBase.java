...
public class ServletUtilBase extends HttpServlet {
  ...
  protected String verifyGDataAuthorization(HttpServletRequest req, HttpServletResponse resp,
      String scope) throws IOException, AuthenticationException{
    
	  String onetimeUseToken = null; 
	  
	  if (req.getQueryString() != null){
		  onetimeUseToken = AuthSubUtil.getTokenFromReply(req.getQueryString());
	  }
	  
    String sessionToken = null;

    if (onetimeUseToken == null) {
      throw new AuthenticationException("GData Service not Authenticated");   //ODKGDataServiceNotAuthenticated();
    } else {
