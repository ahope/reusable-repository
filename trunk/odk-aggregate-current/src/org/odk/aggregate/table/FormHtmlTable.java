...
import org.odk.aggregate.servlet.XmlServlet;
...
public class FormHtmlTable {
  ...
  private static List<String> HEADERS =
      Arrays.asList(TableConsts.FT_HEADER_NAME, TableConsts.FT_HEADER_ODKID,
          TableConsts.FT_HEADER_USER, TableConsts.FT_HEADER_RESULTS, TableConsts.FT_HEADER_CSV, TableConsts.FT_HEADER_XML,
  ...
  public String generateHtmlFormTable() {
    ...
    try {
      ...
      for (Form form : forms) {
        ...
        String xmlDataButton = HtmlUtil.createHtmlButtonToGetServlet(XmlServlet.ADDR,
        		TableConsts.DATA_XML_BUTTON_TXT, properties);
